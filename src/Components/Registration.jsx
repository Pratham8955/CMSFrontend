  ...
  return (
    <div className="d-flex align-items-center justify-content-center" style={{ minHeight: "100vh", background: "linear-gradient(to right, #f8f9fa, #e3f2fd)" }}>
      ...
      <form onSubmit={handleSubmit} className="p-4 rounded shadow-sm border bg-white" style={{ width: "600px" }}>
        ...
        <div className="row mb-3">
          <div className="col">
            <input type="text" name="tenthSchool" value={formData.tenthSchool} onChange={handleChange} className="form-control" placeholder="10th School" />
          </div>
          <div className="col">
            <input type="text" name="tenthPassingYear" value={formData.tenthPassingYear} onChange={handleChange} className="form-control" placeholder="10th Passing Year" />
          </div>
          <div className="col">
            <input type="text" name="tenthPercentage" value={formData.tenthPercentage} onChange={handleChange} className="form-control" placeholder="10th %%" />
          </div>
          <div className="col">
            <input type="file" name="tenthmarksheet" onChange={handleChange} className="form-control" />
          </div>
        </div>
        ...
        <div className="row mb-3">
          <div className="col">
            <input type="text" name="twelfthSchool" value={formData.twelfthSchool} onChange={handleChange} className="form-control" placeholder="12th School" />
          </div>
          <div className="col">
            <input type="text" name="tewelfthPassingYear" value={formData.tewelfthPassingYear} onChange={handleChange} className="form-control" placeholder="12th Passing Year" />
          </div>
          <div className="col">
            <input type="text" name="tewelfthPercentage" value={formData.tewelfthPercentage} onChange={handleChange} className="form-control" placeholder="12th %%" />
          </div>
          <div className="col">
            <input type="file" name="tewelfthMarksheet" onChange={handleChange} className="form-control" />
          </div>
        </div>
