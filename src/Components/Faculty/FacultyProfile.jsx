      ...
      <div className="faculty-profile">
        ...
        <div className="faculty-grid">
          <div className="profile-card border-info">
            <h4 className="profile-section-title mb-3">Contact Details</h4>
            <p><strong>Email:</strong> {faculty.email}</p>
            <p><strong>Gender:</strong> {faculty.gender}</p>
          </div>

          <div className="profile-card border-success">
            <h4 className="profile-section-title mb-3">Education & Experience</h4>
          ...
          <div className="profile-card border-warning">
            <h4 className="profile-section-title mb-3">Professional Details</h4>
